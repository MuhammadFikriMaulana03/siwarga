<x-layouts.admin title="Tambah UMKM" header="Tambah UMKM">
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 max-w-4xl">
        <form action="{{ route('admin.umkms.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="pemilik" value="{{ old('pemilik') }}"
                       class="w-full rounded-xl border-slate-300 focus:border-indigo-500 focus:ring-indigo-500"
                       placeholder="Isi kalau tidak memilih data warga">
            </div>
            ...
            <div>
                ...
                <input type="text" name="kategori" value="{{ old('kategori') }}"
                       class="w-full rounded-xl border-slate-300 focus:border-indigo-500 focus:ring-indigo-500"
                       placeholder="Contoh: Kuliner, Jasa, Fashion">
            </div>
            ...
            <div>
                <label class="block text-sm font-semibold mb-2">Foto Usaha</label>
