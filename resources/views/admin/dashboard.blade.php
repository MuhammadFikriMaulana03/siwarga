        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="space-y-3">
                    <div>
                        <div class="flex justify-between text-xs mb-1">
                            ...
                            <span class="font-semibold">{{ $totalLakiLaki }} orang</span>
                        </div>
                        <div class="h-2 rounded-full bg-slate-100">
                            <div class="h-full rounded-full bg-blue-500" style="width: {{ max($persenLakiLaki, 5) }}%"></div>
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between text-xs mb-1">
                            <span class="text-pink-600 font-medium">Perempuan</span>
                            <span class="font-semibold">{{ $totalPerempuan }} orang</span>
                        </div>
                        <div class="h-2 rounded-full bg-slate-100">
                            <div class="h-full rounded-full bg-pink-500" style="width: {{ max($persenPerempuan, 5) }}%"></div>
                        </div>
                    </div>
                    <div class="pt-2 border-t border-slate-100">
                        <div class="flex justify-between text-xs">
                            <span class="text-slate-600 font-medium">Total</span>
                            <span class="font-bold text-indigo-600">{{ $totalLakiLaki + $totalPerempuan }} orang</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-slate-100 p-5">
                ...
                <div class="space-y-3">
                    <div>
                        <div class="flex justify-between text-xs mb-1">
                            <span class="text-amber-600 font-medium">Lansia</span>
                            <span class="font-semibold">{{ $totalLansia }} orang</span>
                        </div>
                        <div class="h-2 rounded-full bg-slate-100">
                            <div class="h-full rounded-full bg-amber-500" style="width: {{ max($persenLansia, 5) }}%"></div>
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between text-xs mb-1">
                            <span class="text-violet-600 font-medium">Non-Lansia</span>
                            <span class="font-semibold">{{ $totalNonLansia }} orang</span>
                        </div>
                        <div class="h-2 rounded-full bg-slate-100">
                            <div class="h-full rounded-full bg-violet-500" style="width: {{ max($persenNonLansia, 5) }}%"></div>
                        </div>
                    </div>
                    <div class="pt-2 border-t border-slate-100">
                        <div class="flex justify-between text-xs">
                            <span class="text-slate-600 font-medium">Total Lansia</span>
                            <span class="font-bold text-amber-600">{{ $totalLansia }} orang</span>
                        </div>
                    </div>
                </div>
            </div>
