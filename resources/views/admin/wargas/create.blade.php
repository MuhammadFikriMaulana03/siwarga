<x-layouts.admin title="Tambah Warga" header="Tambah Warga">
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 max-w-4xl">
        <form action="{{ route('admin.wargas.store') }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-5">
            @csrf
    ...
    <select name="kartu_keluarga_id"
        ...
        @foreach ($kartuKeluargas as $kk)
            <option value="{{ $kk->id }}"
                    ...
                    @selected(old('kartu_keluarga_id') == $kk->id)>
        ...
        @endforeach
            ...
            <div>
                ...
                @php
                    ...
                    $oldAgama = old('agama');
                    $oldAgamaLainnya = old('agama_lainnya');

                    $isAgamaLainnya = $oldAgama === 'Lainnya';
                @endphp
                ...
                <select name="agama"
                    ...
                    @foreach ($agamaOptions as $agama)
                        <option value="{{ $agama }}" @selected($oldAgama === $agama)>
                            {{ $agama }}
                        </option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <select name="status_warga" class="w-full rounded-xl border-slate-300 focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <option value="kontrak" @selected(old('status_warga') == 'kontrak')>Kontrak</option>
                    <option value="pendatang" @selected(old('status_warga') == 'pendatang')>Pendatang</option>
                </select>
            </div>
