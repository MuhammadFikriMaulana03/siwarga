<x-layouts.admin>
    <div class="p-6 max-w-4xl">
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-extrabold text-slate-900">Tambah User</h1>
            <p class="text-slate-500 text-sm">Buat akun login baru.</p>
        </div>
            ...
            <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <select name="role" id="roleSelect"
                        ...
                        <option value="admin_rw" {{ old('role') === 'admin_rw' ? 'selected' : '' }}>Admin RW</option>
